...
public class CountSubarrayZeroSum {
    ...
    public int solve(ArrayList<Integer> A) {
        ...
        for (int i = 0; i < A.size(); i++) {
            ...
            if (map.containsKey(prefixSum)) result = result % mod + map.get(prefixSum);
